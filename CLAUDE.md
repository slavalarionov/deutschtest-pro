...
- **Единица продажи:** один модуль (Lesen/Hören/Schreiben/Sprechen).
- **Цена:** 40₽ / $0.50 / €0.45 за модуль.
- **Минимальная покупка:** 4 модуля. Дальше 5, 6, …, 10 (скидка ~10% на 10).
- **Гибкость:** купленные модули тратятся на любые из четырёх.
- **Бесплатно при регистрации:** 2 модуля любых на выбор.
- **Оплата:** Точка (РФ), Prodamus (международные). **Интеграций пока нет в коде.**
